...
public class GetPassengerDetailsAdapter  {

//    Context context;
//    Passengers passengerUsers;
//
//    public GetPassengerDetailsAdapter(Context context, Passengers passengerUsers) {
...
//
//        holder.passengerFirstName.setText(passengerUsers.getFirstname());
//        Log.i("TAG", "onBindViewHolder: fnme "+passengerUsers.getFirstname());
//        holder.passengerLastName.setText(passengerUsers.getLastname());
////        holder.passengerPhoto.setText(passengerUserList.get(position).getPhoto());
//        holder.passengerUserId.setText(passengerUsers.getUserId().toString());
//    }
//
//    @Override
//    public int getItemCount() {
//        return passengerUsers.getUserId();
//    }
//
//
