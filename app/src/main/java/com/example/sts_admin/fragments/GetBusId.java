...
import com.example.sts_admin.activity.GetReport;
...
public class GetBusId extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        return inflater.inflate(R.layout.fragment_get_bus_id, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        recyclerViewBusItems = view.findViewById(R.id.rv_bus_details);
            ...
            public void onResponse(Call<BusScheduleResponse> call, Response<BusScheduleResponse> response) {
                if (response.isSuccessful() && response.body() != null){
                    ...
                    recyclerViewBusItems.setAdapter(new BusAdapter(busList, getContext(), new BusAdapter.OnBusItemClickListener() {
                        @Override
                        public void onClickListener(Integer busId, String busRegNo) {
                            Intent i = new Intent(getContext(), GetReport.class);
